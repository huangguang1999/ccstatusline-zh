...
> 本项目是 [ccstatusline](https://github.com/sirmalloc/ccstatusline) 的**中文汉化 Fork**，当前同步至上游 v2.2.18 版本（含 Voice Status、版本固定全局安装、Jujutsu VCS、CompactionCounter、超额用量组件等最新功能）。所有用户可见的界面文本（组件名称、分类、描述、菜单标签、提示信息等）均已翻译为中文，方便中文用户使用。
...
| 功能差异   | —            | 无，功能完全一致          |
| 同步版本   | 最新         | v2.2.18（+ jj widgets / CompactionCounter / Voice Status / 版本固定安装 / 超额用量组件 / 中文化覆盖） |
