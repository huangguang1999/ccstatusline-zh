...
const RECLAIMED_SLOT: SymbolSlot = { id: 'symbolReclaimed', label: '回收箭头', defaultSymbol: '↓' };
...
export class CompactionCounterWidget implements Widget {
    ...
    getCustomKeybinds(item?: WidgetItem): CustomKeybind[] {
        ...
        keybinds.push({ key: 's', label: '(s)按触发类型拆分', action: TOGGLE_TRIGGERS_ACTION });
        keybinds.push({ key: 't', label: '(t)回收 tokens 数', action: TOGGLE_RECLAIMED_ACTION });
