...
export class CompactionCounterWidget implements Widget {
    ...
    getCustomKeybinds(item?: WidgetItem): CustomKeybind[] {
        ...
        keybinds.push({ key: 's', label: '(s)触发器拆分', action: TOGGLE_TRIGGERS_ACTION });
        keybinds.push({ key: 't', label: '(t)已回收 token', action: TOGGLE_RECLAIMED_ACTION });
