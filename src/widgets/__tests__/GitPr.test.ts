...
describe('GitPrWidget', () => {
    it('should render preview with OSC 8 link', () => {
        ...
        expect(result).toBe(
            `${renderOsc8Link('https://github.com/owner/repo/pull/42', 'PR #42')} OPEN 示例 PR 标题`
        );
    });
    ...
    it('should render preview with rawValue', () => {
        ...
        expect(result).toBe(
            `${renderOsc8Link('https://github.com/owner/repo/pull/42', '#42')} OPEN 示例 PR 标题`
        );
    });
    ...
    it('should render preview without status when hideStatus enabled', () => {
        ...
        expect(result).toBe(
            `${renderOsc8Link('https://github.com/owner/repo/pull/42', 'PR #42')} 示例 PR 标题`
        );
    });
