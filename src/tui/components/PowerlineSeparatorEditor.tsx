    ...
    const getPresets = () => {
        if (mode === 'separator') {
            return [
                ...
                { char: '\uE0B4', name: '圆弧（右）', hex: 'E0B4' },
                { char: '\uE0B6', name: '圆弧（左）', hex: 'E0B6' }
            ];
        } else if (mode === 'startCap') {
            return [
                { char: '\uE0B2', name: '三角形', hex: 'E0B2' },
                { char: '\uE0B6', name: '圆弧', hex: 'E0B6' },
                { char: '\uE0BA', name: '下三角', hex: 'E0BA' },
                { char: '\uE0BE', name: '对角线', hex: 'E0BE' }
            ];
        } else {
            return [
                { char: '\uE0B0', name: '三角形', hex: 'E0B0' },
                { char: '\uE0B4', name: '圆弧', hex: 'E0B4' },
                { char: '\uE0B8', name: '下三角', hex: 'E0B8' },
                { char: '\uE0BC', name: '对角线', hex: 'E0BC' }
            ];
        }
    };
        ...
        <Box flexDirection='column'>
            ...
            {hexInputMode ? (
                <Box marginTop={2} flexDirection='column'>
                    ...
                    <Text dimColor>输入 4-6 位十六进制数字（0-9, A-F）表示 Unicode 码点，然后按 Enter 确认。ESC 取消。</Text>
