...
describe('global package manager inspection', () => {
    ...
    it('detects npm installs through WSL path variants', () => {
        mockExecFileSync({
            'which -a ccstatusline-zh': '',
            'npm prefix -g': 'C:\\Users\\Alice\\AppData\\Roaming\\npm\n'
        });
        vi.spyOn(fs, 'existsSync').mockImplementation(filePath => (
            filePath === '/mnt/c/Users/Alice/AppData/Roaming/npm/ccstatusline-zh'
        ));
    ...
    it('identifies the active package manager and version from the first PATH match', () => {
        mockExecFileSync({
            'which -a ccstatusline-zh': '/Users/alice/.bun/bin/ccstatusline-zh\n/Users/alice/.nvm/versions/node/v24.9.0/bin/ccstatusline-zh\n',
            'npm prefix -g': '/Users/alice/.nvm/versions/node/v24.9.0\n',
            'bun pm bin -g': '/Users/alice/.bun/bin\n'
        });
        vi.spyOn(fs, 'existsSync').mockImplementation(filePath => (
            filePath === '/Users/alice/.bun/install/global/node_modules/ccstatusline-zh/package.json'
        ));
        vi.spyOn(fs, 'readFileSync').mockImplementation((filePath) => {
            if (filePath === '/Users/alice/.bun/install/global/node_modules/ccstatusline-zh/package.json') {
        ...
        expect(activeCommand).toEqual({
            ...
            version: '2.2.13',
            warning: '⚠ PATH 中存在多个 ccstatusline-zh 可执行文件，Claude Code 将使用第一个匹配：/Users/alice/.bun/bin/ccstatusline-zh。\n其他匹配：/Users/alice/.nvm/versions/node/v24.9.0/bin/ccstatusline-zh'
        });
    });
    ...
    it('uses npm.cmd for Windows npm version lookup', () => {
        ...
        vi.spyOn(fs, 'existsSync').mockImplementation(filePath => (
            filePath === 'C:\\Users\\Alice\\AppData\\Roaming\\npm\\node_modules\\ccstatusline-zh\\package.json'
        ));
        vi.spyOn(fs, 'readFileSync').mockImplementation((filePath) => {
    ...
    it('uses npm.cmd for Windows npm uninstalls', async () => {
        ...
        expect(execFileSpy.mock.calls[0]?.[1]).toEqual(['uninstall', '-g', 'ccstatusline-zh']);
    });
});
