...
describe('usage window helpers', () => {
    ...
    it('formats duration in block timer style', () => {
        expect(formatUsageDuration(0)).toBe('0分');
        expect(formatUsageDuration(3 * 60 * 60 * 1000)).toBe('3时');
        expect(formatUsageDuration(3.5 * 60 * 60 * 1000)).toBe('3时 30分');
        expect(formatUsageDuration(4 * 60 * 60 * 1000 + 5 * 60 * 1000)).toBe('4时 5分');
    });

    it('formats duration with days when >= 24h', () => {
        expect(formatUsageDuration(25 * 60 * 60 * 1000)).toBe('1天 1时');
        expect(formatUsageDuration(36.5 * 60 * 60 * 1000)).toBe('1天 12时 30分');
        expect(formatUsageDuration(168 * 60 * 60 * 1000)).toBe('7天');
    });

    it('formats duration in compact style', () => {
        expect(formatUsageDuration(0, true)).toBe('0分');
        expect(formatUsageDuration(3 * 60 * 60 * 1000, true)).toBe('3时');
        expect(formatUsageDuration(3.5 * 60 * 60 * 1000, true)).toBe('3时30分');
        expect(formatUsageDuration(4 * 60 * 60 * 1000 + 5 * 60 * 1000, true)).toBe('4时5分');
    });
    ...
    it('formats duration with days in compact style when >= 24h', () => {
        expect(formatUsageDuration(25 * 60 * 60 * 1000, true)).toBe('1天1时');
        expect(formatUsageDuration(36.5 * 60 * 60 * 1000, true)).toBe('1天12时30分');
        expect(formatUsageDuration(168 * 60 * 60 * 1000, true)).toBe('7天');
    });

    it('formats duration without days when requested', () => {
        expect(formatUsageDuration(25 * 60 * 60 * 1000, false, false)).toBe('25时');
        expect(formatUsageDuration(36.5 * 60 * 60 * 1000, false, false)).toBe('36时 30分');
        expect(formatUsageDuration(168 * 60 * 60 * 1000, false, false)).toBe('168时');
    });

    it('formats duration without days in compact style when requested', () => {
        expect(formatUsageDuration(25 * 60 * 60 * 1000, true, false)).toBe('25时');
        expect(formatUsageDuration(36.5 * 60 * 60 * 1000, true, false)).toBe('36时30分');
        expect(formatUsageDuration(168 * 60 * 60 * 1000, true, false)).toBe('168时');
    });
});
